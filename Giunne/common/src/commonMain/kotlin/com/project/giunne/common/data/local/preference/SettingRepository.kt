...
//    )
    ...
    val currentLevelPref: SettingConfig<*> = LongSettingConfig(settings, "LEVEL", 0)
    val currentPlayerIdPref: SettingConfig<*> = LongSettingConfig(settings, "CURRENT_PLAYER", 0)
